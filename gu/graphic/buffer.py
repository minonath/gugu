...
class Buffer(object):
    ...
    def __init__(self, data: typing.Union[list, tuple, int], buffer_type: str,
                 buffer_target: str, buffer_mode: str, group_length=1):
        """
        缓存对象
        ...
        """
        _element_type, _element_size = _BUFFER_TYPE[buffer_type]
        ...
        self.__string__ = '<Buffer:{} size:{} ({} | {} | {})>'.format(
            ...
            buffer_type, buffer_target, buffer_mode
        )
