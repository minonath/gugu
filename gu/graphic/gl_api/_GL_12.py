...
PFNGLTEXIMAGE3DPROC = C(None, UInt, Int, Int, Int, Int, Int, Int, UInt, UInt,
                        VoidP)
PFNGLTEXSUBIMAGE3DPROC = C(None, UInt, Int, Int, Int, Int, Int, Int, Int,
                           UInt, UInt, VoidP)
PFNGLCOPYTEXSUBIMAGE3DPROC = C(None, UInt, Int, Int, Int, Int, Int, Int, Int,
                               Int)
glDrawRangeElements = E('glDrawRangeElements', None, UInt, UInt, UInt, Int,
                        UInt, VoidP)
...
glCopyTexSubImage3D = E('glCopyTexSubImage3D', None, UInt, Int, Int, Int, Int,
                        Int, Int, Int, Int)

__all__ = [
    'GL_VERSION_1_2', 'GL_UNSIGNED_BYTE_3_3_2', 'GL_UNSIGNED_SHORT_4_4_4_4',
    'GL_UNSIGNED_SHORT_5_5_5_1', 'GL_UNSIGNED_INT_8_8_8_8',
    'GL_UNSIGNED_INT_10_10_10_2', 'GL_TEXTURE_BINDING_3D',
    ...
    'GL_UNSIGNED_INT_2_10_10_10_REV', 'GL_BGR', 'GL_BGRA',
    'GL_MAX_ELEMENTS_VERTICES', 'GL_MAX_ELEMENTS_INDICES', 'GL_CLAMP_TO_EDGE',
    'GL_TEXTURE_MIN_LOD', 'GL_TEXTURE_MAX_LOD', 'GL_TEXTURE_BASE_LEVEL',
    'GL_TEXTURE_MAX_LEVEL', 'GL_SMOOTH_POINT_SIZE_RANGE',
    'GL_SMOOTH_POINT_SIZE_GRANULARITY', 'GL_SMOOTH_LINE_WIDTH_RANGE',
    'GL_SMOOTH_LINE_WIDTH_GRANULARITY', 'GL_ALIASED_LINE_WIDTH_RANGE',
    'PFNGLDRAWRANGEELEMENTSPROC', 'PFNGLTEXIMAGE3DPROC',
    'PFNGLTEXSUBIMAGE3DPROC', 'PFNGLCOPYTEXSUBIMAGE3DPROC',
    'glDrawRangeElements', 'glTexImage3D', 'glTexSubImage3D',
    'glCopyTexSubImage3D'
]
