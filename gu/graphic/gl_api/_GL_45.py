...
PFNGLCLEARNAMEDBUFFERSUBDATAPROC = C(None, UInt, UInt, Size, Size, UInt, UInt,
                                     VoidP)
...
PFNGLGETNAMEDBUFFERPOINTERVPROC = C(None, UInt, UInt, VoidP)
...
PFNGLINVALIDATENAMEDFRAMEBUFFERSUBDATAPROC = C(None, UInt, Int, P(UInt), Int,
                                               Int, Int, Int)
...
PFNGLBLITNAMEDFRAMEBUFFERPROC = C(None, UInt, UInt, Int, Int, Int, Int, Int,
                                  Int, Int, Int, UInt, UInt)
PFNGLCHECKNAMEDFRAMEBUFFERSTATUSPROC = C(UInt, UInt, UInt)
PFNGLGETNAMEDFRAMEBUFFERPARAMETERIVPROC = C(None, UInt, UInt, P(Int))
PFNGLGETNAMEDFRAMEBUFFERATTACHMENTPARAMETERIVPROC = C(None, UInt, UInt, UInt,
                                                      P(Int))
PFNGLCREATERENDERBUFFERSPROC = C(None, Int, P(UInt))
PFNGLNAMEDRENDERBUFFERSTORAGEPROC = C(None, UInt, UInt, Int, Int)
PFNGLNAMEDRENDERBUFFERSTORAGEMULTISAMPLEPROC = C(None, UInt, Int, UInt, Int,
                                                 Int)
...
PFNGLTEXTURESTORAGE2DMULTISAMPLEPROC = C(None, UInt, Int, UInt, Int, Int,
                                         UByte)
PFNGLTEXTURESTORAGE3DMULTISAMPLEPROC = C(None, UInt, Int, UInt, Int, Int, Int,
                                         UByte)
PFNGLTEXTURESUBIMAGE1DPROC = C(None, UInt, Int, Int, Int, UInt, UInt, VoidP)
PFNGLTEXTURESUBIMAGE2DPROC = C(None, UInt, Int, Int, Int, Int, Int, UInt,
                               UInt, VoidP)
PFNGLTEXTURESUBIMAGE3DPROC = C(None, UInt, Int, Int, Int, Int, Int, Int, Int,
                               UInt, UInt, VoidP)
PFNGLCOMPRESSEDTEXTURESUBIMAGE1DPROC = C(None, UInt, Int, Int, Int, UInt, Int,
                                         VoidP)
PFNGLCOMPRESSEDTEXTURESUBIMAGE2DPROC = C(None, UInt, Int, Int, Int, Int, Int,
                                         UInt, Int, VoidP)
PFNGLCOMPRESSEDTEXTURESUBIMAGE3DPROC = C(None, UInt, Int, Int, Int, Int, Int,
                                         Int, Int, UInt, Int, VoidP)
PFNGLCOPYTEXTURESUBIMAGE1DPROC = C(None, UInt, Int, Int, Int, Int, Int)
PFNGLCOPYTEXTURESUBIMAGE2DPROC = C(None, UInt, Int, Int, Int, Int, Int, Int,
                                   Int)
PFNGLCOPYTEXTURESUBIMAGE3DPROC = C(None, UInt, Int, Int, Int, Int, Int, Int,
                                   Int, Int)
...
PFNGLVERTEXARRAYVERTEXBUFFERSPROC = C(None, UInt, UInt, Int, P(UInt), P(Size),
                                      P(Int))
...
PFNGLGETTEXTURESUBIMAGEPROC = C(None, UInt, Int, Int, Int, Int, Int, Int, Int,
                                UInt, UInt, Int, VoidP)
PFNGLGETCOMPRESSEDTEXTURESUBIMAGEPROC = C(None, UInt, Int, Int, Int, Int, Int,
                                          Int, Int, Int, VoidP)
...
glCreateTransformFeedbacks = E('glCreateTransformFeedbacks', None, Int,
                               P(UInt))
glTransformFeedbackBufferBase = E('glTransformFeedbackBufferBase', None, UInt,
                                  UInt, UInt)
glTransformFeedbackBufferRange = E('glTransformFeedbackBufferRange', None,
                                   UInt, UInt, UInt, Size, Size)
glGetTransformFeedbackiv = E('glGetTransformFeedbackiv', None, UInt, UInt,
                             P(Int))
glGetTransformFeedbacki_v = E('glGetTransformFeedbacki_v', None, UInt, UInt,
                              UInt, P(Int))
glGetTransformFeedbacki64_v = E('glGetTransformFeedbacki64_v', None, UInt,
                                UInt, UInt, P(Int64))
glCreateBuffers = E('glCreateBuffers', None, Int, P(UInt))
glNamedBufferStorage = E('glNamedBufferStorage', None, UInt, Size, VoidP,
                         UInt)
glNamedBufferData = E('glNamedBufferData', None, UInt, Size, VoidP, UInt)
glNamedBufferSubData = E('glNamedBufferSubData', None, UInt, Size, Size,
                         VoidP)
glCopyNamedBufferSubData = E('glCopyNamedBufferSubData', None, UInt, UInt,
                             Size, Size, Size)
glClearNamedBufferData = E('glClearNamedBufferData', None, UInt, UInt, UInt,
                           UInt, VoidP)
...
glMapNamedBufferRange = E('glMapNamedBufferRange', VoidP, UInt, Size, Size,
                          UInt)
glUnmapNamedBuffer = E('glUnmapNamedBuffer', UByte, UInt)
glFlushMappedNamedBufferRange = E('glFlushMappedNamedBufferRange', None, UInt,
                                  Size, Size)
glGetNamedBufferParameteriv = E('glGetNamedBufferParameteriv', None, UInt,
                                UInt, P(Int))
glGetNamedBufferParameteri64v = E('glGetNamedBufferParameteri64v', None, UInt,
                                  UInt, P(Int64))
glGetNamedBufferPointerv = E('glGetNamedBufferPointerv', None, UInt, UInt,
                             VoidP)
glGetNamedBufferSubData = E('glGetNamedBufferSubData', None, UInt, Size, Size,
                            VoidP)
glCreateFramebuffers = E('glCreateFramebuffers', None, Int, P(UInt))
glNamedFramebufferRenderbuffer = E('glNamedFramebufferRenderbuffer', None,
                                   UInt, UInt, UInt, UInt)
glNamedFramebufferParameteri = E('glNamedFramebufferParameteri', None, UInt,
                                 UInt, Int)
glNamedFramebufferTexture = E('glNamedFramebufferTexture', None, UInt, UInt,
                              UInt, Int)
glNamedFramebufferTextureLayer = E('glNamedFramebufferTextureLayer', None,
                                   UInt, UInt, UInt, Int, Int)
glNamedFramebufferDrawBuffer = E('glNamedFramebufferDrawBuffer', None, UInt,
                                 UInt)
glNamedFramebufferDrawBuffers = E('glNamedFramebufferDrawBuffers', None, UInt,
                                  Int, P(UInt))
glNamedFramebufferReadBuffer = E('glNamedFramebufferReadBuffer', None, UInt,
                                 UInt)
glInvalidateNamedFramebufferData = E('glInvalidateNamedFramebufferData', None,
                                     UInt, Int, P(UInt))
glInvalidateNamedFramebufferSubData = E('glInvalidateNamedFramebufferSubData',
                                        None, UInt, Int, P(UInt), Int, Int,
                                        Int, Int)
glClearNamedFramebufferiv = E('glClearNamedFramebufferiv', None, UInt, UInt,
                              Int, P(Int))
glClearNamedFramebufferuiv = E('glClearNamedFramebufferuiv', None, UInt, UInt,
                               Int, P(UInt))
glClearNamedFramebufferfv = E('glClearNamedFramebufferfv', None, UInt, UInt,
                              Int, P(Float))
glClearNamedFramebufferfi = E('glClearNamedFramebufferfi', None, UInt, UInt,
                              Int, Float, Int)
glBlitNamedFramebuffer = E('glBlitNamedFramebuffer', None, UInt, UInt, Int,
                           Int, Int, Int, Int, Int, Int, Int, UInt, UInt)
glCheckNamedFramebufferStatus = E('glCheckNamedFramebufferStatus', UInt, UInt,
                                  UInt)
glGetNamedFramebufferParameteriv = E('glGetNamedFramebufferParameteriv', None,
                                     UInt, UInt, P(Int))
...
glNamedRenderbufferStorage = E('glNamedRenderbufferStorage', None, UInt, UInt,
                               Int, Int)
glNamedRenderbufferStorageMultisample = E(
    'glNamedRenderbufferStorageMultisample', None, UInt, Int, UInt, Int, Int)
glGetNamedRenderbufferParameteriv = E('glGetNamedRenderbufferParameteriv',
                                      None, UInt, UInt, P(Int))
glCreateTextures = E('glCreateTextures', None, UInt, Int, P(UInt))
glTextureBuffer = E('glTextureBuffer', None, UInt, UInt, UInt)
glTextureBufferRange = E('glTextureBufferRange', None, UInt, UInt, UInt, Size,
                         Size)
...
glTextureStorage3D = E('glTextureStorage3D', None, UInt, Int, UInt, Int, Int,
                       Int)
glTextureStorage2DMultisample = E('glTextureStorage2DMultisample', None, UInt,
                                  Int, UInt, Int, Int, UByte)
glTextureStorage3DMultisample = E('glTextureStorage3DMultisample', None, UInt,
                                  Int, UInt, Int, Int, Int, UByte)
glTextureSubImage1D = E('glTextureSubImage1D', None, UInt, Int, Int, Int,
                        UInt, UInt, VoidP)
...
glCompressedTextureSubImage3D = E('glCompressedTextureSubImage3D', None, UInt,
                                  Int, Int, Int, Int, Int, Int, Int, UInt,
                                  Int, VoidP)
glCopyTextureSubImage1D = E('glCopyTextureSubImage1D', None, UInt, Int, Int,
                            Int, Int, Int)
glCopyTextureSubImage2D = E('glCopyTextureSubImage2D', None, UInt, Int, Int,
                            Int, Int, Int, Int, Int)
...
glTextureParameterIuiv = E('glTextureParameterIuiv', None, UInt, UInt,
                           P(UInt))
...
glGetTextureImage = E('glGetTextureImage', None, UInt, Int, UInt, UInt, Int,
                      VoidP)
glGetCompressedTextureImage = E('glGetCompressedTextureImage', None, UInt,
                                Int, Int, VoidP)
glGetTextureLevelParameterfv = E('glGetTextureLevelParameterfv', None, UInt,
                                 Int, UInt, P(Float))
glGetTextureLevelParameteriv = E('glGetTextureLevelParameteriv', None, UInt,
                                 Int, UInt, P(Int))
glGetTextureParameterfv = E('glGetTextureParameterfv', None, UInt, UInt,
                            P(Float))
glGetTextureParameterIiv = E('glGetTextureParameterIiv', None, UInt, UInt,
                             P(Int))
glGetTextureParameterIuiv = E('glGetTextureParameterIuiv', None, UInt, UInt,
                              P(UInt))
glGetTextureParameteriv = E('glGetTextureParameteriv', None, UInt, UInt,
                            P(Int))
...
glVertexArrayVertexBuffer = E('glVertexArrayVertexBuffer', None, UInt, UInt,
                              UInt, Size, Int)
glVertexArrayVertexBuffers = E('glVertexArrayVertexBuffers', None, UInt, UInt,
                               Int, P(UInt), P(Size), P(Int))
glVertexArrayAttribBinding = E('glVertexArrayAttribBinding', None, UInt, UInt,
                               UInt)
glVertexArrayAttribFormat = E('glVertexArrayAttribFormat', None, UInt, UInt,
                              Int, UInt, UByte, UInt)
glVertexArrayAttribIFormat = E('glVertexArrayAttribIFormat', None, UInt, UInt,
                               Int, UInt, UInt)
glVertexArrayAttribLFormat = E('glVertexArrayAttribLFormat', None, UInt, UInt,
                               Int, UInt, UInt)
glVertexArrayBindingDivisor = E('glVertexArrayBindingDivisor', None, UInt,
                                UInt, UInt)
glGetVertexArrayiv = E('glGetVertexArrayiv', None, UInt, UInt, P(Int))
glGetVertexArrayIndexediv = E('glGetVertexArrayIndexediv', None, UInt, UInt,
                              UInt, P(Int))
glGetVertexArrayIndexed64iv = E('glGetVertexArrayIndexed64iv', None, UInt,
                                UInt, UInt, P(Int64))
...
glGetQueryBufferObjecti64v = E('glGetQueryBufferObjecti64v', None, UInt, UInt,
                               UInt, Size)
glGetQueryBufferObjectiv = E('glGetQueryBufferObjectiv', None, UInt, UInt,
                             UInt, Size)
glGetQueryBufferObjectui64v = E('glGetQueryBufferObjectui64v', None, UInt,
                                UInt, UInt, Size)
glGetQueryBufferObjectuiv = E('glGetQueryBufferObjectuiv', None, UInt, UInt,
                              UInt, Size)
...
glGetCompressedTextureSubImage = E('glGetCompressedTextureSubImage', None,
                                   UInt, Int, Int, Int, Int, Int, Int, Int,
                                   Int, VoidP)
glGetGraphicsResetStatus = E('glGetGraphicsResetStatus', UInt)
glGetnCompressedTexImage = E('glGetnCompressedTexImage', None, UInt, Int, Int,
                             VoidP)
...
glReadnPixels = E('glReadnPixels', None, Int, Int, Int, Int, UInt, UInt, Int,
                  VoidP)
