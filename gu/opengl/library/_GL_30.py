...
glGetTransformFeedbackVarying = E(
    'glGetTransformFeedbackVarying', None, UInt, UInt, Int, P(Int), P(Int),
    P(UInt), CharP
)
...
glBlitFramebuffer = E(
    'glBlitFramebuffer', None, Int, Int, Int, Int, Int, Int, Int, Int, UInt,
    UInt
)
